...
!function() {
    ...
    var g = baseUrl + app_relative_path, m = baseUrl + ext_relative_path, x = baseUrl + ews_relative_path;
    document.write('<link rel="stylesheet" type="text/css" href="' + g + 'shared/font-awesome-4.1.0/css/font-awesome.css"/>'), 
    document.write('<link rel="stylesheet" type="text/css" href="' + g + 'shared/patch.css"/>'), 
    document.write('<link rel="stylesheet" type="text/css" href="' + g + "shared/patch-" + i + '.css"/>'), 
    document.write('<script type="text/javascript" src="' + g + "shared/gb-config-debug.js?theme=" + (i || default_theme || "gray") + "&lang=" + lang + "&charset=" + charset + '"></script>'), 
    document.write('<script type="text/javascript" src="' + x + "ews" + ews_mode.js.debug + '.js"></script>'), 
    document.write('<script type="text/javascript" src="' + m + "locale/ext-lang-" + lang + ".js?theme=" + (i || default_theme || "gray") + "&lang=" + lang + "&charset=" + charset + '"></script>'), 
